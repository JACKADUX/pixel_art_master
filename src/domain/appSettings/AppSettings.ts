...
export interface AppSettings {
  ...
  imageViewerSelectionModeEnabled: boolean;
...
export function parseAppSettings(raw: unknown): AppSettings {
  ...
  return {
    ...
    imageViewerSelectionModeEnabled:
      typeof raw.imageViewerSelectionModeEnabled === "boolean"
        ? raw.imageViewerSelectionModeEnabled
        : defaults.imageViewerSelectionModeEnabled,
    symmetryAxisVisible:
