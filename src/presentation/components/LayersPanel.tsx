...
export function LayersPanel() {
  ...
  const handleDrop = (toDisplayIndex: number) => {
    ...
    const fromRealIndex = layers.length - 1 - dragIndex;

    const toRealIndex = layers.length - 1 - toDisplayIndex;
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  ...
                  <span className="h-2 w-2 shrink-0 rounded-full bg-blue-400" title="活动图层" />
