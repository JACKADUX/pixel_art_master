/** GLSL sources — coefficients mirror ColorConverter.rgbToOklab (L77–94). */

export const OKLAB_DISPLAY_VERTEX_SHADER = `#version 300 es
in vec2 a_position;
in vec2 a_texCoord;
out vec2 v_texCoord;
...
export const OKLAB_DISPLAY_FRAGMENT_SHADER = `#version 300 es
...
void main() {
  ...
  float l = clamp(oklabL(tex.rgb), 0.0, 1.0);
